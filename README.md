...
> **И на Raspberry Pi тоже.** Образ собран под обычные компьютеры и под ARM, так что команда выше
> работает и на одноплатнике с 64-битной системой. В покое планировщик занимает около 30 МБ памяти —
> он не заметит, что живёт на плате размером с ладонь.
